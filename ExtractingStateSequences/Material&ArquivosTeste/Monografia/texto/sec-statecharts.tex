...
(@@@@@ FORMALIZAR O EXEMPLO E CITAR FONTE)
...
\item $\Delta$ can be defined by the table:
(@@@@ COMO DEFINO A TABELA DE TRANSICOES????)
...
The following examples were extracted in \cite{harel87:semantics_statecharts}. In figure~\ref{fig:stateFlat} we a statechart and in figure (@@@@@ COLOCAR FIGURA) we have the flat version that would correspond to an automaton.

\begin{figure}[htb]
\includegraphics[width=10cm]{figuras/statechartExample2}
\caption{\label{fig:stateFlat}}
\end{figure}
